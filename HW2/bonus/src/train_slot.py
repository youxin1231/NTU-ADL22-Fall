...
def main():
    ...
    json_path = Path(args.output_dir + f'/id2tag.json')
    json_path.write_text(json.dumps({i: l for i, l in enumerate(label_list)}, indent=2))
    ...
    logger.info("***** Running Token Classification Training *****")
